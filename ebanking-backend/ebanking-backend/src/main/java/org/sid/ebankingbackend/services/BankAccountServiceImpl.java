...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    //Slf4j c'est pour la journalisation
    ...
    @Override
    public Customer upadateCustomer(CustomerDTO customerDTO) {
        log.info("Saving new Customer");
        Customer customer = dtoMapper.fromCustomerDTO(customerDTO);
        Customer upadateCustomer = customerRepository.save(customer);
        return dtoMapper.fromCustomer(upadateCustomer);
    }
    ...
    public List<Customer> searchCustomers(String keyword) {
        ...
        List<Customer> customerDTOS = customers.stream().map(cust -> dtoMapper.fromCustomer(cust)).collect(Collectors.toList());
        return customerDTOS;
    }
